namespace BetterACU.Patches
{
    ...
    internal class WaterParkCreatureUpdatePrefix
    {
        ...
        public static void Prefix(WaterParkCreature __instance)
        {
            ...
            if (!Main.SmcConfig.CreaturePowerGeneration.TryGetValue(techType, out var powerValue)) return;
            ...
            var power = powerValue/10 * (DayNightCycle.main.timePassedAsFloat - time) * Main.SmcConfig.PowerGenSpeed;
