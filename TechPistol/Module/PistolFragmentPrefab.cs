...
internal class PistolFragmentPrefab
{
    ...
    private static LootDistributionData.BiomeData[] GetBiomeDistribution()
    {
		...
		{
#if SUBNAUTICA
            new(){ biome = BiomeType.DeepGrandReef_AbandonedBase_Interior, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.DeepGrandReef_AbandonedBase_Exterior, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.FloatingIslands_AbandonedBase_Inside, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.FloatingIslands_AbandonedBase_Outside, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.JellyShroomCaves_AbandonedBase_Inside, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.JellyshroomCaves_CaveFloor, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.JellyshroomCaves_CaveSand, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LostRiverJunction_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LostRiverCorridor_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LostRiverCorridor_LakeFloor, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LostRiverJunction_LakeFloor, count = 1, probability = 0.05f },
#elif BELOWZERO
            new(){ biome = BiomeType.TwistyBridges_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.TwistyBridges_Deep_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.TwistyBridges_Cave_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.TwistyBridges_Deep_ThermalVentArea_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.GlacialBasin_BikeCrashSite, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.GlacialBasin_Generic, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.GlacialConnection_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.Glacier_Generic, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LilyPads_Crevice_Ground, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LilyPads_Crevice_Grass, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LilyPads_Deep_Grass, count = 1, probability = 0.05f },
            new(){ biome = BiomeType.LilyPads_Deep_Ground, count = 1, probability = 0.05f },
#endif
        };
		return biomeDatas;
    }
